...
def serialize_data(
    ...
    return {
        ...
        'EnemyPlayerOnField_Type 1': enemy_pokemon_conv.type1,
        'EnemyPlayerOnField_Type 2': enemy_pokemon_conv.type2,
        'EnemyPlayerOnField_HP': enemy_pokemon_conv.hp,
        'EnemyPlayerOnField_Atk': enemy_pokemon_conv.atk,
        'EnemyPlayerOnField_Def': enemy_pokemon_conv.def_,
        'EnemyPlayerOnField_SpA': enemy_pokemon_conv.spa,
        'EnemyPlayerOnField_SpD': enemy_pokemon_conv.spd,
        'EnemyPlayerOnField_Spe': enemy_pokemon_conv.spe,
